...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideDisasterReportRepository(
        apiService: DisasterReportApiService,
        pictureApiService: PictureApiService
    ): DisasterReportRepository {
        return DisasterReportRepository(apiService, pictureApiService)
    }
